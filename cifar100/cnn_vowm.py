...
#define the network's structure and activation function
class Net(torch.nn.Module):
    ...
    def __init__(self, inputsize):
        ...
        self.c1 = torch.nn.Conv2d(ncha, 128, kernel_size=2, stride=1, padding=0, bias=False)
        self.c2 = torch.nn.Conv2d(128, 256, kernel_size=2, stride=1,  padding=0, bias=False)
        self.c3 = torch.nn.Conv2d(256, 512, kernel_size=2, stride=1, padding=0, bias=False)

        self.fc1 = torch.nn.Linear(512 * 4 * 4, 1000, bias=False)
